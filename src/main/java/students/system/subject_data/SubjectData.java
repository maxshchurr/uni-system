package students.system.subject_data;
...
public class SubjectData {
    ...
    public static List<String> subjectsFor5TermSoftwareEngineering() {
        return List.of("Mobile apps", "Software modeling and analysis", "Computer networks and communications", "Practice in the specialty", "Optional discipline 1", "Optional discipline 2");
    }

    public static List<String> subjectsFor6TermSoftwareEngineering() {
        return List.of("Software design and architectures", "Internet technologies", "Probability and Applied Statistics", "Analysis of requirements and specifications", "Practice on software technologies", "Optional discipline 1", "Optional discipline 2");
    }

    public static List<String> subjectsFor7TermSoftwareEngineering() {
        return List.of("Software processes", "Web server programming", "Big data", "Software project management", "Optional discipline 1", "Optional discipline 2");
    }

    public static List<String> subjectsFor8TermSoftwareEngineering() {
        return List.of("Internship", "Cybersecurity and sustainable business", "Parallel programming", "Software verification and validation", "Optional discipline 1");
    }

    // Subjects for Software Technologies and Design
    public static List<String> subjectsFor1TermSoftwareTechnologiesAndDesign() {
        return List.of("Introduction to Programming (C#)", "Introduction to Information Technology", "Linear algebra and analytical geometry", "Introduction to Web Programming", "English", "Sports");
    }

    public static List<String> subjectsFor2TermSoftwareTechnologiesAndDesign() {
        return List.of("Creating a GPI (C#)", "Software systems in mathematics", "Object Oriented Programming (C#)", "Basics of graphic design", "Web design", "Specialized English", "Sports");
    }

    public static List<String> subjectsFor3TermSoftwareTechnologiesAndDesign() {
        return List.of("Databases", "Event programming", "Applied Mathematics 1", "Software technologies 1", "Optional discipline 1", "Optional discipline 2", "Sports");
    }

    public static List<String> subjectsFor4TermSoftwareTechnologiesAndDesign() {
        return List.of("Administration of dynamic web systems", "Geometric design", "JAVA programming", "Digital image processing", "Programming on the Internet with PHP and MySQL", "Optional discipline 1", "Optional discipline 2", "Sports");
    }

    public static List<String> subjectsFor5TermSoftwareTechnologiesAndDesign() {
        return List.of("Publishing systems", "Practice in the specialty", "Video and animation creation and processing", "Software technologies 2", "Optional discipline 1", "Optional discipline 2");
    }

    public static List<String> subjectsFor6TermSoftwareTechnologiesAndDesign() {
        return List.of("Creation and processing of vector images", "Computer networks and communications", "Mobile application design", "Mobile application programming", "Optional discipline 1", "Optional discipline 2");
    }

    public static List<String> subjectsFor7TermSoftwareTechnologiesAndDesign() {
        return List.of("E-commerce", "3D model design", "Applied mathematics 2", "Information technologies on the Internet", "Optional discipline 1", "Optional discipline 2");
    }

    public static List<String> subjectsFor8TermSoftwareTechnologiesAndDesign() {
        return List.of("Framework systems for web programming", "Business information systems", "Internship", "Optional discipline");
    }

    // Subjects for Business IT

    public static List<String> subjectsFor1TermBusinessIT() {
        return List.of("Introduction to Computer Science", "Introduction to Information Technology", "Linear algebra and analytical geometry", "Programming", "Law and legal information systems", "English", "Sports");
    }

    public static List<String> subjectsFor2TermBusinessIT() {
        return List.of("Object oriented programming", "Information technology in mathematics", "Banking and banking information systems", "Applied Mathematics", "Law and legal information systems", "Graphics and presentations", "Specialized English", "Sports");
    }

    public static List<String> subjectsFor3TermBusinessIT() {
        return List.of("Programming using .NET", "Marketing and marketing information systems", "Financial mathematics", "Insurance mathematics", "Information technologies on the Internet", "Optional discipline 1", "Optional discipline 2", "Sports");
    }

    public static List<String> subjectsFor4TermBusinessIT() {
        return List.of("Econometrics", "Programming on the Internet with PHP and MySQL", "Databases", "Accounting and accounting information systems", "Optional discipline 1", "Optional discipline 2", "Sports");
    }

    public static List<String> subjectsFor5TermBusinessIT() {
        return List.of("JAVA programming", "Software technologies", "Introduction to Cloud Technologies", "Practice in the specialty", "Optional discipline 1", "Optional discipline 2");
    }

    public static List<String> subjectsFor6TermBusinessIT() {
        return List.of("Modeling and management of business processes", "Computer networks and communications", "Investments and investment techniques", "Web design", "Optional discipline 1", "Optional discipline 2");
    }

    public static List<String> subjectsFor7TermBusinessIT() {
        return List.of("Optimization models in economics", "E-commerce", "Insurance and insurance information systems", "Business English with Information Technology", "Optional discipline 1", "Optional discipline 2");
    }
